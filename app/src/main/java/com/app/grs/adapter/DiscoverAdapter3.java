...
public class DiscoverAdapter3 extends RecyclerView.Adapter<DiscoverAdapter3.MyViewHolder> {

    private Context mContext;
    private ArrayList<HashMap<String,String>> discoverList3;

    public DiscoverAdapter3(Context mContext, ArrayList<HashMap<String, String>> discoverList3) {
        this.mContext = mContext;
        this.discoverList3 = discoverList3;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.discover_layout3, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final HashMap<String,String> itemmap = discoverList3.get(position);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            image = itemView.findViewById(R.id.discover_iv3);
            name = itemView.findViewById(R.id.discover_tv3);
        }
    }
}
